...
export default function Hero() {
  ...
  return (
    <section 
      id="inicio" 
      className="relative pt-24 pb-16 md:pt-36 md:pb-24 min-h-screen flex items-center bg-black overflow-hidden"
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className={`w-full lg:w-1/2 transition-all duration-1000 ${
            ...
            <div className="mb-6">
              <div 
                className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl text-white leading-tight sm:leading-none whitespace-nowrap" 
              ...
              <div className="w-48 sm:w-64 h-1 bg-gradient-to-r from-[#BC6C25] to-transparent mt-4 sm:mt-6"></div>
            </div>
            
            {/* Subtítulo Ajustado */}
            <div className="mb-6">
              <h2 className="text-lg sm:text-xl md:text-2xl text-gray-200 font-light tracking-wide uppercase inline-block border-b border-[#BC6C25]/50 pb-1">
                Corretora de Imóveis
              </h2>
              <div className="w-16 sm:w-20 h-0.5 bg-gradient-to-r from-[#BC6C25] to-transparent mt-1"></div>
            </div>
            
            {/* Descrição Ajustada */}
            <p className="text-base sm:text-lg md:text-xl mb-8 text-gray-300 max-w-xl leading-relaxed font-light">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="group relative px-6 sm:px-8 py-3 sm:py-4 font-semibold transition-all duration-500 overflow-hidden
              ...
              <button
                ...
                className="px-6 sm:px-8 py-3 sm:py-4 font-medium transition-all duration-500 group
